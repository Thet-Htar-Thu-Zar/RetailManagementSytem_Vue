...
<template class="flex flex-col items-center">
    <div class="flex justify-center items-center space-x-4 mb-5">
        <Button
            ...
            class="bg-blue-500 hover:bg-blue-600 rounded-full flex justify-center items-center space-x-2"
        ...
        <Button class="bg-yellow-500 hover:bg-yellow-600 rounded-full p-2 px-4 shadow-md"
            @click="openUpdateProductDialog(props.product)">
            <EditIcon /> Edit
        </Button>
        <Button class="bg-red-600 hover:bg-red-700 rounded-full p-2 px-4 shadow-md"

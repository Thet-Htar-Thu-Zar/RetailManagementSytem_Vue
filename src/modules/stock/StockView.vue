...
<template>
  <section class="p-3 h-full bg-gray-50">
    <TableCaption class="text-3xl font-semibold text-center text-slate-700 flex justify-center">Stock Page🛍🎗</TableCaption>

    <div class="flex justify-end mb-5">
        <RouterLink to="/cart" class="flex items-center justify-center bg-gradient-to-r from-green-400 to-blue-500 hover:bg-slate-700 text-white py-2 px-4 rounded-lg shadow-2xl transition duration-300 relative">
    ...
    <Table class="w-full bg-white shadow-md rounded-lg overflow-hidden">
      <TableHeader class="bg-gradient-to-r from-green-200 to-blue-300">
        <TableRow>
          ...
          <TableHead class="px-6 py-3 text-left text-sm font-medium text-gray-600 flex justify-center">Action</TableHead>
        </TableRow>
      </TableHeader>
      ...
      <TableBody>
        <TableRow v-for="(product,index) in data" :key="index" class="hover:bg-gray-100 transition duration-200">
          ...
          <TableCell class="px-6 py-4 flex gap-3 ml-5">
            <Button
            ...
            <Button
              ...
              Remove <LucideShoppingCart class="inline h-4 w-4 ml-1" />
            </Button>
          </TableCell>
        </TableRow>
      </TableBody>
